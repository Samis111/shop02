<template>
  <div class="brand-management">
    ...
    >
      ...
      <el-table-column prop="type" label="品牌类型"></el-table-column>
      
      <el-table-column prop="description" label="品牌描述" show-overflow-tooltip></el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item label="品牌类型" prop="type">
          <el-select v-model="brandForm.type" placeholder="请选择品牌类型">
            <el-option label="服装" value="clothing"></el-option>
            <el-option label="鞋靴" value="shoes"></el-option>
            <el-option label="配饰" value="accessories"></el-option>
          </el-select>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      uploadUrl: process.env.VUE_APP_BASE_API + '/admin/upload/brand-logo'
    }
  },
